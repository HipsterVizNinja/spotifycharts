...
PROGRESS_BAR_TIME_FORMAT = configuration.str('PROGRESS_BAR_TIME_FORMAT')
...
LOG_WARNING_FILE_NAME = configuration.str('LOG_WARNING_FILE_NAME')
LOG_INFO_FILE_NAME = configuration.str('LOG_INFO_FILE_NAME')
